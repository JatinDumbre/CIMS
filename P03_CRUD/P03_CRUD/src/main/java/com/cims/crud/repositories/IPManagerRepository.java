...
public interface IPManagerRepository extends JpaRepository<User,Integer> {
	@Query(nativeQuery=true,value="SELECT p1.project_id, p1.project_name, l1.loc_name,l1.loc_add,l1.loc_city, pm.fname AS project_manager,so.fname AS site_operator"
			+ " FROM project p1"
